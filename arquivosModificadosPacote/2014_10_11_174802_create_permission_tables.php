...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Permission::create(['name' => 'Alterar config']);
        Permission::create(['name' => 'Excluir config']);
        Permission::create(['name' => 'Visualizar config']);
        Permission::create(['name' => 'Cadastrar config']);
